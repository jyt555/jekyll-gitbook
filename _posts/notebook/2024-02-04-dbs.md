...
| 参考资料 | [Chritch](https://obsidian.zerokei.top/Hub/Database%20System/) | [小角龙](https://zhang-each.github.io/My-CS-Notebook/DB/db/) | [DB_book](https://db-book.com/Practice-Exercises/index-solu.html) |
...
令关系$r_1,r_2$的属性集分别为$R_1,R_2$，主码分别为$K_1,K_2$。如果要求对$r_2$中任意元组$t_2$，均存在$r_1$中元组$t_1$使得$t_1.K_1=t_2.\alpha$，我们称$R_2$的子集$\alpha$为参照关系$r_1$中$K_1$的外码。(参照关系中外码的值必须在被参照关系中实际存在，或为null)
...
![](../../assets/notebook/Snipaste_2024-04-01_13-52-39.png)
